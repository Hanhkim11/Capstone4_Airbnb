    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      <div className="user-profile flex justify-center col-span-1">
          ...
          title={
            <>
              <div className="flex flex-col items-center p-3">
                ...
                />
                <Button type="link" className="underline !text-lg">
                  Cập nhập ảnh
                </Button>
              </div>
        ...
        >
          ...
          <p className="text-sm text-gray-500">
            Số điện thoại: {userLogin?.user.phone}
          </p>
        </Card>
      </div>
      ...
      <div className="booking-room col-span-2">
        ...
        <Button
          type="link"
          className="underline !text-lg !p-0 !text-black !font-medium"
        >
          Chỉnh sửa hồ sơ
        </Button>
        ...
        <div className="list-room mt-4">
          ...
          {bookingRoom.length > 0 ? (
            <RenderListBookingRoom ListBookingRoom={bookingRoom} />
          ) : (
