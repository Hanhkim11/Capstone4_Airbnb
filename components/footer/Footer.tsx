    ...
    return (
        <footer className="bg-gray-100 text-md text-gray-700 mt-10">
            <div className="max-w-7xl mx-auto px-4 py-10 border-t">
                {/* Danh mục */}
                <div>
                    <h2 className="font-semibold text-lg mb-4">Nguồn cảm hứng cho những kỳ nghỉ sau này</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 border-b pb-8">
                        {[
                            "Hồ bơi tuyệt vời", "Bắc Cực", "Khu cắm trại", "Xe cắm trại", "Lâu đài",
                            "Nông thôn", "Thiết kế", "Nhà dưới lòng đất", "Nông trại", "Công viên quốc gia",
                            "Thật ấn tượng!", "Nhà nhỏ", "Tháp", "Cối xay gió", "Luxe",
                            "Container", "Vườn nho"
                        ].map((item, index) => (
                ...
                <div className="mt-10 border-t pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                    <div className="space-x-4 mb-2 md:mb-0">
                        ...
                        <span className="hover:underline cursor-pointer">Sơ đồ trang web</span>
                    </div>
